...
if ( ! function_exists( 'thirtyfourteen_post_thumbnail_title' ) ) :
/**
 * Display an optional post thumbnail as title bg.
 *
 * Wraps the post thumbnail in an anchor element on index
 * views, or a div element when on single views.
 *
 * @since Thirty Fourteen 1.0
 * @since Thirty Fourteen 1.4 Was made 'pluggable', or overridable.
 */
function thirtyfourteen_post_thumbnail_title() {
